...
export default function Planeacion() {
  ...
  const pendingQuery = useQuery({ queryKey: ["pendingPlanning"], queryFn: api.getPendingPlanning });
  ...
  return (
    <div className="space-y-4">
      ...
      <AsyncState
        query={pendingQuery}
        skeleton={<SkeletonRows rows={4} cols={5} />}
        emptyMessage="No hay pedidos pendientes de generar orden de producción."
        errorMessage="No se pudieron cargar los pedidos pendientes de planeación."
      >
        {(pending) => (
          <>
