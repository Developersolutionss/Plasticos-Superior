  ...
  return (
    <div className={`app-shell ${collapsed ? "collapsed" : ""}`}>
      ...
      <div className="flex flex-col min-h-screen">
        <header className="bg-white border-b px-4 sm:px-6 py-3 flex items-center justify-between sm:justify-end gap-4">
          <button
            type="button"
            className="md:hidden text-slate-600 p-1 -ml-1"
